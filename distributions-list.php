                ...
                <?php
                  ...
                  ?>
                      ...
                      <?php include '../program/resources-td-content.php';?>
                        ...
                        <a href="../farmer/farmer-view.php?id=<?= $row['farmer_id'];?>" class="btn btn-sm btn-success"><i class="bi bi-person-circle"></i></a>
