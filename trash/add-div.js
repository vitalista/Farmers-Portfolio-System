...
document.getElementById('addFarmButton').addEventListener('click', async function() {
    ...
    newFarmCard.querySelector('.addCropButton').addEventListener('click', async function() {
        ...
        cropInputDiv.className = 'col-md-6 mt-1';
        cropInputDiv.innerHTML = `<input type="hidden" class="parcelNum" value="${farmCounter}" style="width: 100%;">
        <div class="card shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <label class="form-label d-block mb-2" style="font-size: 19px; font-weight: bold;">
                    Size (Ha):
                    <input type="text" class="form-control rounded-3" placeholder="(Ha)">
                  </label>
                  
                  <fieldset class="mt-3">
                    <legend style="font-size: 19px; font-weight: bold;">Organic Practitioner:</legend>
                    <div class="form-check form-check-inline">
                      <input type="radio" class="form-check-input" name="organicPractitioner1" id="organicYes1">
                      <label class="form-check-label" for="organicYes1">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input type="radio" class="form-check-input" name="organicPractitioner1" id="organicNo1">
                      <label class="form-check-label" for="organicNo1">No</label>
                    </div>
                  </fieldset>
                </div>
    ...
    newFarmCard.querySelector('.addLivestockButton').addEventListener('click', function() {
        ...
        livestockInputDiv.className = 'col-md-6 mt-1';
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <label class="form-label d-block mb-2" style="font-size: 19px; font-weight: bold;">
                    ...
                    <input type="text" class="form-control rounded-3" placeholder="Per Head">
                  </label>
                  
                  <fieldset class="mt-3">
                    <legend style="font-size: 19px; font-weight: bold;">Organic Practitioner:</legend>
                    <div class="form-check form-check-inline">
                      <input type="radio" class="form-check-input" name="organicPractitioner2" id="organicYes2">
                      <label class="form-check-label" for="organicYes2">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input type="radio" class="form-check-input" name="organicPractitioner2" id="organicNo2">
                      <label class="form-check-label" for="organicNo2">No</label>
                    </div>
                  </fieldset>
                </div>
              </div>
