      ...
      <div class="row">
        <div class="col-lg-12 main-table">
          ...
          <div class="card-body">
            ...
            <!-- Default Tabs -->
            <form class="needs-validation" novalidate action="user-add-code.php" method="POST">
                    ...
                    <div class="col-md-12 mt-5">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                          ...
                          <input type="text" name="email" class="form-control p-3" id="yourUsername" required autocomplete="off">
                      ...
                      <div class="row mt-4">
                        ...
                        <div class="col-sm-4 mt-2">
                          ...
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="bannedSwitch">
                        ...
                        <div class="col-sm-3">
                          <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" id="promoteSwitch">
