window.addEventListener('load', function() {
  document.getElementById('livestock-image').style.backgroundImage = "url('assets/img/Agri%20Livestock.jpg')";
  document.getElementById('seeds-image').style.backgroundImage = "url('assets/img/Agri%20seeds.jpg')";
  document.getElementById('cash-assistance-image').style.backgroundImage = "url('assets/img/Agri%20Cash.jpg')";
  document.getElementById('fertilizer-image').style.backgroundImage = "url('assets/img/Agri%20Fertilizer.jpg')";
  document.getElementById('machine-distribution-image').style.backgroundImage = "url('assets/img/Agri%20Machine.jpg')";
});
...
window.innerWidth < 768 &&
  ...
  (function (e) {
    ...
    var t,
      ...
      g =
          ...
          (i = function (e, t, n, i) {
            ...
            if ("undefined" == y || "function" == y) {
              for (
                ...
                if ("require" === (u = (p = r(t[h], b)).f)) g[h] = a.require(e);
                else if ("exports" === u) (g[h] = a.exports(e)), (f = !0);
                else if ("module" === u) o = g[h] = a.module(e);
        ...
        x.define("select2/results", ["jquery", "./utils"], function (e, t) {
          ...
          return (
            ...
            (n.prototype.option = function (n) {
              ...
              for (i in (((null != n.element &&
                r.call(n.element, ":disabled")) ||
                ...
                if ((this.clear(), 0 !== e.length)) {
                  for (
                    ...
                    c && r.attr("title", c),
                      ...
                      (c = r.find(".select2-selection__choice__remove")).attr(
                        "title",
                        a()
                      ),
                      c.attr("aria-label", a()),
              ...
              t.call(this, n, s),
                n.on("*", function (t, n) {
                  ...
                  -1 !== o.indexOf(t) &&
                    ...
                    i.$element.trigger(s),
                    -1 !== r.indexOf(t) &&
                      (n.prevented = s.isDefaultPrevented()));
                });
            }),
            t
          );
        ...
        x.define("select2/translation", ["jquery", "require"], function (e, t) {
          ...
          return (
            ...
            (n.loadPath = function (e) {
              var s;
              return (
                e in n._cache || ((s = t(e)), (n._cache[e] = s)),
                new n(n._cache[e])
              );
            }),
            n
              ...
              (s.prototype.option = function (e) {
                ...
                return (
                  e.children
                    ...
                    : void 0 !==
                      (s = document.createElement("option")).textContent
              ...
              this._removeOldTags(),
                null != t.term && null == t.page
                  ? e.call(this, t, function e(i, o) {
                      for (var r = i.results, a = 0; a < r.length; a++) {
                        var l = r[a],
                          c =
                            null != l.children &&
            ...
            return (
              ...
              (n.prototype._positionDropdown = function () {
                ...
                var a = this.$dropdown.outerHeight(!1),
                  ...
                  u = l < o.top - a;
                (t = c > o.bottom + a), (l = { left: o.left, top: r.bottom });
          ...
          function (
            ...
            return (
              (T.prototype.apply = function (u) {
                ...
                null == (u = e.extend(!0, {}, this.defaults, u)).dataAdapter &&
                  ...
                  null == u.resultsAdapter &&
                    ...
                    u.tags &&
                      (u.resultsAdapter = c.Decorate(u.resultsAdapter, L))),
                  ...
                  u.language.push("en");
                for (var C = [], T = 0; T < u.language.length; T++) {
                  var q = u.language[T];
                ...
                this.defaults = {
                  ...
                  matcher: function n(s, i) {
                    ...
                    if (i.children && 0 < i.children.length) {
                      for (
                        var o = e.extend(!0, {}, i), r = i.children.length - 1;
                        0 <= r;
                        r--
                      )
                        null == n(s, i.children[r]) && o.children.splice(r, 1);
                      return 0 < o.children.length ? o : n(s, o);
                    }
              ...
              (T.prototype._resolveLanguage = function (t) {
                ...
                for (
                  var n, s = Array.isArray(t) ? t : [t], i = [], o = 0;
                  o < s.length;
                  o++
                )
                  i.push(s[o]),
              ...
              (T.prototype._processTranslations = function (t, n) {
                for (var s = new u(), i = 0; i < t.length; i++) {
                  ...
                  else o = e.isPlainObject(r) ? new u(r) : r;
                  s.extend(o);
                }
                return s;
              }),
          ...
          function (e, t, n, s) {
            var i = function (e, s) {
              ...
              n.StoreData(e[0], "old-tabindex", o),
                ...
                (o = this.options.get("resultsAdapter")),
        ...
        { define: x.define, require: x.require });
    function m(e, t) {
      return p.call(e, t);
    }
    function y(e, t) {
  ...
  document.querySelectorAll(".hover-card").forEach((e) => {
    const t = e.querySelector(".gradient-overlay");
