! function(n) {
	...
	let svgPdf = '<i class="bi bi-file-earmark-pdf-fill"></i>',
		svgCopy = '<i class="bi bi-scissors"></i>',
		svgExcel = '<i class="bi bi-file-earmark-excel-fill"></i>',
		svgCsv = '<i class="bi bi-file-earmark-text-fill"></i>';
	...
	return n.ext.buttons.copyHtml5 = {
		...
		text: function(t) {
			return t.i18n("buttons.copy", svgCopy)
		},
		...
		text: function(t) {
			return t.i18n("buttons.csv", svgCsv)
		},
		action: function(t, e, o, l) {
			this.processing(!0);
			var n = u(e, l).str,
		...
		text: function(t) {
			return t.i18n("buttons.excel", svgExcel)
		},
		...
		text: function(t) {
			return t.i18n("buttons.pdf", svgPdf);
		},
		action: function(t, e, o, l) {
			this.processing(!0);
